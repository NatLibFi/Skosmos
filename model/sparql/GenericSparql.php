...
EOQ;
     ...
     * @return string sparql query
     */
    protected function generateConceptSearchQuery($fields, $unique, $params, $showDeprecated) {
...
EOQ;
     ...
     * @return array query result object
     */
    public function queryConcepts($vocabs, $fields = null, $unique = false, $params, $showDeprecated) {
     ...
     * @return string sparql query
     */
    protected function generateAlphabeticalListQuery($letter, $lang, $limit, $offset, $classes, $showDeprecated) {
        $fcl = $this->generateFromClause();
        $classes = ($classes) ? $classes : array('http://www.w3.org/2004/02/skos/core#Concept');
        $values = $this->formatValues('?type', $classes, 'uri');
...
EOQ;
     ...
     */
    public function queryConceptsAlphabetical($letter, $lang, $limit = null, $offset = null, $classes = null,$showDeprecated) {
...
EOQ;
     ...
     * @return string sparql query
     */
    private function generateConceptGroupContentsQuery($groupClass, $group, $lang, $showDeprecated) {
        $fcl = $this->generateFromClause();
        $filterDeprecated="";
        if($showDeprecated==false){
...
EOQ;
     ...
     */
    public function listConceptGroupContents($groupClass, $group, $lang,$showDeprecated) {
